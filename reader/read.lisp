...
;;; this code is essentially the above with some modifications
;;; for clicl. Principal differences are
;;;    1. uses crate for the package system
;;;      find-symbol, find-package, intern
;;;      symbol-name (tests)
