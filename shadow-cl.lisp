...
(defparameter *shadow-3-evaluation-and-compilation*
  '((cl:&allow-other-keys :shadow)
    ...
    (cl:defmacro :shadow :clicl-redefines)
...
(defparameter *shadow-7-objects*
  '((cl:add-method :box-out)
    ...
    (cl:class-name :shadow)
    (cl:class-of :shadow)
    (cl:compute-applicable-methods :box-out)
    (cl:defclass :shadow :clicl-redefines)
    (cl:defgeneric :shadow :clicl-redefines)
    (cl:define-method-combination :box-out)
    (cl:defmethod :shadow :clicl-redefines)
    ...
    (cl:with-accessors :shadow)
    (cl:with-slots :shadow)))
...
(defparameter *shadow-22-printer*
  '((cl:*print-array* :ignore)
    ...
    (cl:format :shadow :clicl-printer)
    (cl:formatter :shadow :clicl-printer)
    (cl:pprint :shadow :clicl-printer)
    ...
    (cl:prin1 :shadow :clicl-printer)
    (cl:prin1-to-string :shadow :clicl-printer)
    (cl:princ :shadow :clicl-printer)
    (cl:princ-to-string :shadow :clicl-printer)
    (cl:print :shadow :clicl-printer)
    ...
    (cl:write :shadow :clicl-printer)
    (cl:write-to-string :shadow :clicl-printer)))
...
(defparameter *shadow-23-reader*
  '((cl:*read-base* :ignore)
    ...
    (cl:read :shadow :clicl-reader) 
    (cl:read-delimited-list :box-out)
    (cl:read-from-string :shadow :clicl-reader) 
    (cl:read-preserving-whitespace :shadow :clicl-reader)
